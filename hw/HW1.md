...
*Then, sketch your own diagram of what you think the internet's structure looks like at four levels: (1) your neighborhood, (2) UNM's campus, (3) city of Albuquerque, and (4) state of New Mexico. Upload a photo or scan of your sketch (pen and paper is fine).*

*Please note:*

- *Base this only on the textbook diagram and your own reasoning, you do not need to look anything up or know specific jargon.*
- *These sketches should be quick. Do not overthink it.*
...
+ **UNM Campus Level**
	+ I focused mainly on including desktops that are likely connected over ethernet to an access point/router and mobile/laptop devices that connect to the UNM network. The one thing I included that I'm not really certain on is the separate access points for the lobo wifi and the guest wifi connections. I'm not certain that that is actually how it is maintained, but an attempt on my first thought. I drew this before Thursday's class, but likely should have added some servers--I initially didn't include because I was not entirely sure how much self-hosting UNM does with applications. So much is remotely hosted now that I didn't make that initial assumption to include.
+ **City of Albuquerque Level**
